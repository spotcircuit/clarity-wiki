...
- [[patterns/config-driven-routing]] -- example of a well-structured pattern page
- [[decisions/multi-format-ingest-strategy]] -- example of a decision page with rationale
