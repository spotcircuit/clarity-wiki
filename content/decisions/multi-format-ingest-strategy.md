...
- [[patterns/config-driven-routing]] -- the config-driven approach this decision implements
- [[patterns/error-handling]] -- unknown formats that fail AI extraction route to exception queues
- [[patterns/mock-data-strategy]] -- mock configs for testing new formats before real data arrives
- [[patterns/pre-release-checklist]] -- config records must be reviewed before release
